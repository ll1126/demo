...
public class Check {
    ...
    public static String checkFile(String path) throws Exception {
        ...
        String res = HttpUtil.doPost(Const.BAIDU_General_Basic + AuthToken.getAuth(),param,Const.content_type_www);
    ...
    private static String post(String param) throws URISyntaxException, IOException {
        ...
        URI url = new URI(Const.BAIDU_General_Basic + AuthToken.getAuth());
        post.setURI(url);
