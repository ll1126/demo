...
//    }
     ...
     * @param keys
     */
    @AfterReturning(value = "execution(* com.test.demo.controller..*.*(..))",returning = "keys")
    public void doAfterReturningAdvice1(JoinPoint joinPoint,Object keys){

        System.out.println("第一个后置返回通知的返回值："+keys);
    }

    @AfterReturning(value = "execution(* com.test.demo.controller..*.*(..))",returning = "keys",argNames = "keys")
